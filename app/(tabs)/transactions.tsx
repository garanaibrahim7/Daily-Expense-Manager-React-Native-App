...
export default function HistoryScreen() {
  ...
  useEffect(() => {
    ...
    if (params.filterType) {
      setFilterType(params.filterType as any);
    }
  }, [params.modeId, params.filterType]);
          ...
          <View style={styles.transactionInfo}>
            <View style={styles.transactionTopRow}>
              ...
              <View style={styles.modeTag}>
                ...
                <Text
                  style={[styles.modeTagText, { color: mode?.color || '#999' }]}
                >
                  {mode?.name || 'Unknown'}
                </Text>
              </View>
  ...
  const renderSectionHeader = ({
    ...
    <Text style={styles.dateHeader}>
      {format(new Date(title), 'MMM dd, yyyy')}
    </Text>
  );
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <TouchableOpacity
          style={[
            styles.filterButton,
            filterType === 'year' && styles.filterButtonActive,
          ]}
        ...
        >
          <Text
            style={[
              styles.filterButtonText,
              filterType === 'year' && styles.filterButtonTextActive,
            ]}
          >
            This Year
          </Text>
        ...
        >
          ...
          >
            {customStartDate && customEndDate
              ? `${format(customStartDate, 'dd MMM')} - ${format(
                customEndDate,
                'dd MMM'
              )}`
              : 'Custom'}
        ...
        <TouchableOpacity
          style={[
            styles.filterButton,
            selectedType === 'in' && styles.filterButtonActive,
          ]}
          onPress={() => setSelectedType(selectedType === 'in' ? 'all' : 'in')}
        >
          <TrendingUp
            size={14}
            color={selectedType === 'in' ? '#fff' : '#10b981'}
          />
          <Text
            style={[
              styles.filterButtonText,
              selectedType === 'in' && styles.filterButtonTextActive,
            ]}
          >
            Income
          </Text>
        ...
        <TouchableOpacity
          style={[
            styles.filterButton,
            selectedType === 'out' && styles.filterButtonActive,
          ]}
          onPress={() => setSelectedType(selectedType === 'out' ? 'all' : 'out')}
        >
          <TrendingDown
            size={14}
            color={selectedType === 'out' ? '#fff' : '#ef4444'}
          />
          <Text
            style={[
              styles.filterButtonText,
              selectedType === 'out' && styles.filterButtonTextActive,
            ]}
          >
            Expense
          </Text>
